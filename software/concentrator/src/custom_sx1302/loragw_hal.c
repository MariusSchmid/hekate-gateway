...
#include "const_arb_fw.var"        /* text_arb_sx1302_13_Nov_3 */
#include "const_agc_fw_sx1250.var" /* text_agc_sx1250_05_Juillet_2019_3 */
#include "const_agc_fw_sx1257.var" /* text_agc_sx1257_19_Nov_1 */
...
static lgw_context_t lgw_context = {
    ...
    .lora_service_cfg = {.enable = 0,   /* not used, handled by if_chain_cfg */
                         ...
                         .implicit_crc_en = 0,
                         .implicit_coderate = 0},
    .fsk_cfg = {.enable = 0,   /* not used, handled by if_chain_cfg */
                .rf_chain = 0, /* not used, handled by if_chain_cfg */
                .freq_hz = 0,  /* not used, handled by if_chain_cfg */
                .bandwidth = BW_125KHZ,
                .datarate = 50000,
                .sync_word_size = 3,
                .sync_word = 0xC194C1},
    .tx_gain_lut = {{.size = 1, .lut[0] = {.rf_power = 14, .dig_gain = 0, .pa_gain = 2, .dac_gain = 3, .mix_gain = 10, .offset_i = 0, .offset_q = 0, .pwr_idx = 0}}, {.size = 1, .lut[0] = {.rf_power = 14, .dig_gain = 0, .pa_gain = 2, .dac_gain = 3, .mix_gain = 10, .offset_i = 0, .offset_q = 0, .pwr_idx = 0}}},
    .ftime_cfg = {.enable = false, .mode = LGW_FTIME_MODE_ALL_SF},
    .sx1261_cfg = {.enable = false, .spi_path = "/dev/spidev0.1", .rssi_offset = 0, .lbt_conf = {.rssi_target = 0, .nb_channel = 0, .channels = {{0}}}},
    .debug_cfg = {.nb_ref_payload = 0, .log_file_name = "loragw_hal.log"}};
...
int lgw_receive(uint8_t max_pkt, struct lgw_pkt_rx_s *pkt_data)
{
    ...
    float current_temperature = 20.0, rssi_temperature_offset = 0.0;
